...
while True:
      ...
      if opcion == 1:
            ruta_actual = os.getcwd() ## Obtiene el directorio de trabajo actual
            print(f"El directorio actual es {ruta_actual}")
            
      elif opcion == 2:
            contenido = os.listdir(os.getcwd()) ## os.listdir() devuelve una lista de los archivos y carpetas en el directorio actual
            for elemento in contenido:
                  print(f"estos elementos estan en el directorio actual: {elemento}")     
            
      elif opcion == 3:
            nueva_carpeta = input("ingresa el nombre de la carpeta nueva:")## os.mkdir() crea un directorio con el nombre especificado
            ...
            carpeta_actual = input("ingresa el nombre de la carpeta a renombrar:")##      os.rename() renombra un archivo o directorio
            ...
            carpeta_destino = input("ingresa el nombre de la carpeta donde quieres crear el archivo:")## Verifica si la carpeta existe
      ...
      if opcion == 6:
            carpeta = input("ingresa el nombre de la carpeta donde se encuentra el archivo:")## Verifica si la carpeta existe
            ...
            carpeta = input("ingresa el nombre de la carpeta donde se encuenta el archivo:")## Verifica si la carpeta existe
      ...
      repetir = input("¿Deseas realizar otra operación? (s/n): ").lower() ## Permite al usuario decidir si quiere repetir el proceso
      if repetir !="s":
